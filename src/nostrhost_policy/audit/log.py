...
class AuditLog:
    ...
    def verify(self) -> list[str]:
        ...
        deletion, reordering, or truncation. Malformed lines are reported as
        ...
        for index, entry in enumerate(self._read_all()):
            ...
            if not isinstance(stored_hash, str):
                ...
                continue
            # entry_hash covers the entry WITHOUT its own entry_hash field.
    ...
    def _read_all(self) -> list[dict[str, Any]]:
        ...
        for line in data.splitlines():
            ...
            try:
                ...
                # A corrupt/truncated line is skipped for reads but surfaced
                # by verify().
                continue
        return entries
